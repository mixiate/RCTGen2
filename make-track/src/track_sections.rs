...
pub struct TrackSection {
    ...
    pub length: f32,
    pub tiles: heapless::Vec<[i16; 3], MAX_TILE_COUNT>,
...
impl PartialEq for TrackSection {
...
pub static STEEP_TO_VERTICAL: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [32, 0, 0]]),
...
pub static FLAT_TO_STEEP: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 0], [-64, 0, 16], [-96, 0, 40]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: true,
    invert_alt_mesh: false,
...
pub static STEEP_TO_FLAT: TrackSection = TrackSection {
    ...
    length: crate::track_curves::FLAT_TO_STEEP_LENGTH,
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 40], [-64, 0, 64], [-96, 0, 80]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: true,
    invert_alt_mesh: true,
...
pub static SMALL_TURN_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [0, -32, 0], [-32, 0, 0], [-32, -32, 0]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static LARGE_TURN_LEFT_TO_DIAG: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 0], [-32, -32, 0], [-64, 0, 0], [-64, -32, 0]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static SMALL_TURN_LEFT_GENTLE: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [0, -32, 16], [-32, 0, 16], [-32, -32, 16]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static LARGE_TURN_LEFT_TO_DIAG_GENTLE: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 16], [-32, -32, 32], [-64, 0, 32], [-64, -32, 32]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static LARGE_TURN_LEFT_TO_ORTHOGONAL_GENTLE: TrackSection = TrackSection {
    ...
    length: crate::track_curves::LARGE_TURN_GENTLE_LENGTH,
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 0], [0, 32, 0], [-32, 32, 16], [-64, 32, 32]]),
    position_offset: POSITION_OFFSET_NONE,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static LARGE_TURN_RIGHT_TO_ORTHOGONAL_GENTLE: TrackSection = TrackSection {
    ...
    length: crate::track_curves::LARGE_TURN_GENTLE_LENGTH,
    tiles: heapless::Vec::from_array([[0, 0, 0], [0, 32, 0], [-32, 0, 0], [-32, 32, 16], [-32, 64, 32]]),
    position_offset: POSITION_OFFSET_NONE,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static SMALL_TURN_LEFT_STEEP: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [0, -32, 48], [-32, 0, 48], [-32, -32, 48]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: true,
...
pub static LARGE_TURN_LEFT_TO_DIAG_STEEP: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 48], [-32, -32, 48], [-64, 0, 96], [-64, -32, 96]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static LARGE_TURN_LEFT_TO_ORTHOGONAL_STEEP: TrackSection = TrackSection {
    ...
    length: crate::track_curves::LARGE_TURN_STEEP_LENGTH,
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 0], [0, 32, 0], [-32, 32, 32], [-64, 32, 96]]),
    position_offset: POSITION_OFFSET_NONE,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static LARGE_TURN_RIGHT_TO_ORTHOGONAL_STEEP: TrackSection = TrackSection {
    ...
    length: crate::track_curves::LARGE_TURN_STEEP_LENGTH,
    tiles: heapless::Vec::from_array([[0, 0, 0], [0, 32, 0], [-32, 0, 0], [-32, 32, 32], [-32, 64, 96]]),
    position_offset: POSITION_OFFSET_NONE,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static VERTICAL_TWIST_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [0, 32, 0]]),
    position_offset: POSITION_OFFSET_NONE,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static S_BEND_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 0], [-32, -32, 0], [-64, -32, 0]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static SMALL_TURN_LEFT_BANK_TO_GENTLE: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [0, -32, 0], [-32, 0, 0], [-32, -32, 16]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static BARREL_ROLL_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 0], [-64, 0, 0]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static INLINE_TWIST_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 0], [-64, 0, 16]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static HALF_LOOP: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 16], [-64, 0, 32], [-32, 0, 120]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static VERTICAL_LOOP_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 16], [-64, 0, 32], [-32, 0, 120], [-32, -32, 120]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static QUARTER_LOOP: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [32, 0, 56], [64, 0, 96]]),
    position_offset: POSITION_OFFSET_NONE,
    mask_offset_y: false,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static CORKSCREW_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 24], [-32, -32, 48]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static MEDIUM_HALF_LOOP_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 16], [-64, 0, 56], [-64, -32, 56], [-32, -32, 168]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static ZERO_G_ROLL_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 8], [-64, 0, 24]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: false,
    invert_alt_mesh: false,
...
pub static LARGE_ZERO_G_ROLL_LEFT: TrackSection = TrackSection {
    ...
    tiles: heapless::Vec::from_array([[0, 0, 0], [-32, 0, 56], [-64, 0, 96], [-96, 0, 120]]),
    position_offset: POSITION_OFFSET_ORTHOGONAL,
    mask_offset_y: true,
    prefer_odd_alt_mesh_count: true,
    invert_alt_mesh: true,
...
pub static CORKSCREW_LEFT_DIAG: TrackSection = TrackSection {
    name: "corkscrew_left_diag",
    curve: crate::track_curves::corkscrew_left_diag,
    length: crate::track_curves::CORKSCREW_DIAG_LENGTH,
    tiles: heapless::Vec::from_array([
        [0, 0, 0],
        [-32, 0, 0],
        [0, 32, 0],
...
pub static CORKSCREW_RIGHT_DIAG: TrackSection = TrackSection {
    name: "corkscrew_right_diag",
    curve: crate::track_curves::corkscrew_right_diag,
    length: crate::track_curves::CORKSCREW_DIAG_LENGTH,
    tiles: heapless::Vec::from_array([
        [0, 0, 0],
        [0, 32, 0],
...
pub const TRACK_SECTIONS: [&TrackSection; 156] = [
    &FLAT,
    &FLAT_TO_GENTLE,
    &GENTLE_TO_FLAT,
    &GENTLE,
